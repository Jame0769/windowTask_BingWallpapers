...
Param(
    ...
    [ValidateSet('auto', '1024x768', '1280x720', '1366x768', '1920x1080', '2560x1440')][string]$resolution = 'auto',

    # Destination folder to download the wallpapers to
    [string]$downloadFolder = "R:\Development\Automation Factory\100_Share\013_Jame\wallpaper"
)
...
[string]$hostname = "http://global.bing.com/"
...
[xml]$content = $request.DownloadString($uri)
